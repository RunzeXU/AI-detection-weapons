...
This is a collaborative research project with a company called `Integrated` and`Hong Kong Metropolitan University`. The research project aims to design an AI-based software function which can automatically detect and recognize firearms, knives, and other weapons in a streaming video captured by surveillance camera.
*****
# Abstract
